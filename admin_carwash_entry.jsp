...
h2 {font-family:Syncopate;border-style: solid; }
 ...
 <input type="submit" value="back to admin page" class="btn0" ><br>
...
try
{
  ...
  ResultSet rs=stmt.executeQuery("select * from booking_details order by c_id DESC");
  ...
  <form action="update.jsp" method="post">
    <input type="hidden" id="cid" name="cid" value=<%=rs.getInt("c_id")%>>
    <input type="submit" value="Approved" name="approved" class="btn1">
    <input type="submit" value="Disapproved" name="disapproved" class="btn2">
    <input type="submit" value="Delete" name="delete" class="btn3">
    </form>
